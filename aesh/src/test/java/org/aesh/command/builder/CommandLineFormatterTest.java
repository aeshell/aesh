...
public class CommandLineFormatterTest {
    ...
    public void testHelp_MultiLineOptionDescription() throws CommandLineParserException {
        ...
        // Continuation should be indented (start with spaces)
        assertTrue("Continuation should be indented",
                continuation.startsWith("  ") && continuation.trim().startsWith("Must be"));
